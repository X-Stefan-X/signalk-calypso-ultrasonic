...
class Ultrasonic extends EventEmitter {
  ...
  generateDelta (model) {
    const values = [
      ...
      {
        path: 'electrical.batteries.calypso.name',
        value: 'Calypso Ultrasonic'
      },
      {
        path: 'electrical.batteries.calypso.location',
        value: 'Mast'
      },
      {
        path: 'electrical.batteries.calypso.capacity.stateOfCharge',
